...
|8|1.0.0|03.12.2024|Kulasekaran|1) Automatic provisioning  2) Teaching mode made more reliable  3) ErrorCodes modified  4) LED Indications changed  5) Button press functionalities changed|[Ver 1.0.0]()|

## High level overview

- something can be filled here
