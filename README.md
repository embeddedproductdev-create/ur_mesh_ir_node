...
|3|0.8.1|28.06.2024|Kulasekaran|1) Location string length increased from 20 to 30<br>2) Temperature Data ACK converted into Heartbeat ACK <br> 3) Minimum value for Heartbeat publish configuration increased from 5 to 10<br>3) Added Purple LED indication when sending out and IR signal<br>4) Added Teaching mode start Packets for both Gwy/Node<br>5) Added Teaching Mode End ACK for both Gwy and Node<br>6) Added Debug Info packets for both Gwy and Node<br>7) Error code values changed<br>8) LED indication change for Teaching mode and AC Remote configuration mode<br>9) Added BootUp LED indication<br>10) Modified Button Press Logics|[Ver 0.8.1]()|
