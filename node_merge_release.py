...
script produces one fully self-contained merged firmware image containing:
    ...
    0x1b000  <SERIAL>.bin        (unique per device, e.g. N00001.bin)
...
Usage:
    ...
    python node_merge_release.py --version v1.1.3   # override detected version
...
Prerequisites:
    ...
    3. Run this script to produce versioned merged binaries.
    4. Flash one device and verify before sending to client.
