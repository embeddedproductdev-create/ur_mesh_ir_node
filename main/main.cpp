...
IRDaikinESP ac_Daikin216(kSendPin);
...
void app_main(void)
{
    ...
    // if(pthread_create(&send_tid, NULL, send_task, NULL)!=0){
    //     perror("Error in creating send_task : ");
    // }
}
